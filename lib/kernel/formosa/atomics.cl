...
#define FORMOSA_DEF_AMO_HELPER(TYPE, NAME, ASM)                                 \
  ...
  formosa_##NAME(volatile __global TYPE *p, TYPE val) {                         \
    TYPE old;                                                                   \
...
#define FORMOSA_DEF_BIN_AND_ALIAS(NAME, TYPE, BODY)                             \
  __attribute__((overloadable)) TYPE atomic_##NAME(volatile __global TYPE *p,   \
                                                   TYPE val) {                  \
    BODY                                                                        \
  }                                                                             \
  __attribute__((overloadable)) TYPE atom_##NAME(volatile __global TYPE *p,     \
                                                 TYPE val) {                    \
